...
if [ "$#" -eq 2 ] && [ "$1" -eq 20 ] || [ "$1" -eq 30 ] && [ "$2" = "ns" ] || [ "$2" = "us" ] || [ "$2" = "ms" ] || [ "$2" = "s" ]; then
    ...
    do
        ...
        do
            ...
            perl -i -pe "s/threads_per_block = \d+/threads_per_block = $blocks_and_threads/g" constants.py
            perl -i -pe "s/blocks_per_grid = \d+/blocks_per_grid = $blocks_and_threads/g" constants.py
