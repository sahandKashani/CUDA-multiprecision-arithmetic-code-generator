...
blocks_per_grid = 32
coalesced_m_file_name = '../data/coalesced_m.txt'
coalesced_a_file_name = '../data/coalesced_a.txt'
coalesced_b_file_name = '../data/coalesced_b.txt'
coalesced_a_mon_file_name = '../data/coalesced_a_mon.txt'
coalesced_b_mon_file_name = '../data/coalesced_b_mon.txt'
add_results_file_name = '../data/add_results.txt'
sub_results_file_name = '../data/sub_results.txt'
mul_results_file_name = '../data/mul_results.txt'
mul_karatsuba_results_file_name = '../data/mul_karatsuba_results.txt'
add_m_results_file_name = '../data/add_m_results.txt'
sub_m_results_file_name = '../data/sub_m_results.txt'
montgomery_reduction_results_file_name = '../data/montgomery_reduction_results.txt'
coalesced_T_mon_file_name = '../data/coalesced_T_mon.txt'
inverse_R_file_name = '../data/inverse_R.txt'
m_prime_file_name = '../data/m_prime.txt'
...
R = 2 ** precision
number_of_bignums_in_files = threads_per_block * blocks_per_grid
