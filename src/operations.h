...
{\
    ...
    {\
        ...
        asm("addc.cc.u32 %0, %1,  0;" : "=r"(a0_plus_a1[2]) : "r"(a1[2]));\
        asm("addc.u32    %0, %1,  0;" : "=r"(a0_plus_a1[3]) : "r"(a1[3]));\
    }\
    {\
        asm("add.cc.u32  %0, %1, %2;" : "=r"(b0_plus_b1[0]) : "r"(b0[0]), "r"(b1[0]));\
        asm("addc.cc.u32 %0, %1, %2;" : "=r"(b0_plus_b1[1]) : "r"(b0[1]), "r"(b1[1]));\
        asm("addc.cc.u32 %0, %1,  0;" : "=r"(b0_plus_b1[2]) : "r"(b1[2]));\
        asm("addc.u32    %0, %1,  0;" : "=r"(b0_plus_b1[3]) : "r"(b1[3]));\
    }\
}
