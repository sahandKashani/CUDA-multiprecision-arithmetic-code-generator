...
{\
    ...
    uint32_t c2[3] = {0, 0, 0};\
    uint32_t a0[4] = {a_loc[0], a_loc[1], a_loc[2], 0};\
    uint32_t b0[4] = {b_loc[0], b_loc[1], b_loc[2], 0};\
    uint32_t a1[4] = {a_loc[3], a_loc[4], 0, 0};\
    uint32_t b1[4] = {b_loc[3], b_loc[4], 0, 0};\
    ...
    {\
        ...
        asm("addc.u32    %0, %1, %2;" : "=r"(a0_plus_a1[3]) : "r"(a0[3]), "r"(a1[3]));\
    }\
    {\
        ...
        asm("addc.u32    %0, %1, %2;" : "=r"(b0_plus_b1[3]) : "r"(b0[3]), "r"(b1[3]));\
    }\
    {\
        uint32_t carry = 0;\
    ...
    {\
        ...
        asm("subc.u32    %0, %1, %2;" : "=r"(c1[3]) : "r"(c1[3]), "r"(c0[3]));\
    }\
    {\
        ...
        asm("subc.u32    %0, %1, %2;" : "=r"(c1[3]) : "r"(c1[3]), "r"(c2[3]));\
    }\
}
