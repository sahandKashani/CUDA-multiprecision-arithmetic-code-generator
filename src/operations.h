...
{\
    ...
    for(uint32_t i = 0; i < 10; i++)\
                   ...
                   printf("\n");\
    asm("add.u32 %0, %1,  0;" : "=r"(c_loc[0]) : "r"(A[0]));\
    asm("add.u32 %0, %1,  0;" : "=r"(c_loc[1]) : "r"(A[1]));\
    asm("add.u32 %0, %1,  0;" : "=r"(c_loc[2]) : "r"(A[2]));\
    asm("add.u32 %0, %1,  0;" : "=r"(c_loc[3]) : "r"(A[3]));\
    asm("add.u32 %0, %1,  0;" : "=r"(c_loc[4]) : "r"(A[4]));\
    asm("add.u32 %0, %1,  0;" : "=r"(c_loc[5]) : "r"(A[5]));\
    asm("add.u32 %0, %1,  0;" : "=r"(c_loc[6]) : "r"(A[6]));\
    asm("add.u32 %0, %1,  0;" : "=r"(c_loc[7]) : "r"(A[7]));\
    asm("add.u32 %0, %1,  0;" : "=r"(c_loc[8]) : "r"(A[8]));\
    asm("add.u32 %0, %1,  0;" : "=r"(c_loc[9]) : "r"(A[9]));\
}
