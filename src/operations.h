...
{\
    ...
    uint32_t b0_plus_b1[3] = {0, 0, 0};\
        ...
        asm("addc.u32      %0, %0,  0    ;" : "+r"(carry));\
        asm("mad.hi.u32    %0, %1, %2, %3;" : "=r"(c0[3]) : "r"(b_loc[1]), "r"(a_loc[1]), "r"(carry));\
        }\
        {\
        uint32_t carry = 0;\
        asm("mul.lo.u32    %0, %1, %2    ;" : "=r"(c2[0]) : "r"(b_loc[2]), "r"(a_loc[2]));\
        asm("mul.hi.u32    %0, %1, %2    ;" : "=r"(c2[1]) : "r"(b_loc[2]), "r"(a_loc[2]));\
        asm("mad.lo.cc.u32 %0, %1, %2, %0;" : "+r"(c2[1]) : "r"(b_loc[2]), "r"(a_loc[3]));\
        asm("addc.u32      %0, %0,  0    ;" : "+r"(carry));\
        asm("mad.lo.cc.u32 %0, %1, %2, %0;" : "+r"(c2[1]) : "r"(b_loc[3]), "r"(a_loc[2]));\
        asm("addc.u32      %0, %0,  0    ;" : "+r"(carry));\
        asm("add.u32       %0, %1,  0    ;" : "=r"(c2[2]) : "r"(carry));\
        asm("add.u32       %0,  0,  0    ;" : "=r"(carry));\
        asm("mad.hi.cc.u32 %0, %1, %2, %0;" : "+r"(c2[2]) : "r"(b_loc[2]), "r"(a_loc[3]));\
        asm("addc.u32      %0, %0,  0    ;" : "+r"(carry));\
        asm("mad.hi.cc.u32 %0, %1, %2, %0;" : "+r"(c2[2]) : "r"(b_loc[3]), "r"(a_loc[2]));\
        asm("addc.u32      %0, %0,  0    ;" : "+r"(carry));\
        asm("mad.lo.cc.u32 %0, %1, %2, %0;" : "+r"(c2[2]) : "r"(b_loc[2]), "r"(a_loc[4]));\
        asm("addc.u32      %0, %0,  0    ;" : "+r"(carry));\
        asm("mad.lo.cc.u32 %0, %1, %2, %0;" : "+r"(c2[2]) : "r"(b_loc[3]), "r"(a_loc[3]));\
        asm("addc.u32      %0, %0,  0    ;" : "+r"(carry));\
        asm("mad.lo.cc.u32 %0, %1, %2, %0;" : "+r"(c2[2]) : "r"(b_loc[4]), "r"(a_loc[2]));\
        asm("addc.u32      %0, %0,  0    ;" : "+r"(carry));\
        asm("add.u32       %0, %1,  0    ;" : "=r"(c2[3]) : "r"(carry));\
        asm("add.u32       %0,  0,  0    ;" : "=r"(carry));\
        asm("mad.hi.cc.u32 %0, %1, %2, %0;" : "+r"(c2[3]) : "r"(b_loc[2]), "r"(a_loc[4]));\
        asm("addc.u32      %0, %0,  0    ;" : "+r"(carry));\
        asm("mad.hi.cc.u32 %0, %1, %2, %0;" : "+r"(c2[3]) : "r"(b_loc[3]), "r"(a_loc[3]));\
        asm("addc.u32      %0, %0,  0    ;" : "+r"(carry));\
        asm("mad.hi.cc.u32 %0, %1, %2, %0;" : "+r"(c2[3]) : "r"(b_loc[4]), "r"(a_loc[2]));\
        asm("addc.u32      %0, %0,  0    ;" : "+r"(carry));\
        asm("mad.lo.cc.u32 %0, %1, %2, %0;" : "+r"(c2[3]) : "r"(b_loc[3]), "r"(a_loc[4]));\
        asm("addc.u32      %0, %0,  0    ;" : "+r"(carry));\
        asm("mad.lo.cc.u32 %0, %1, %2, %0;" : "+r"(c2[3]) : "r"(b_loc[4]), "r"(a_loc[3]));\
        asm("addc.u32      %0, %0,  0    ;" : "+r"(carry));\
        asm("add.u32       %0, %1,  0    ;" : "=r"(c2[4]) : "r"(carry));\
        asm("add.u32       %0,  0,  0    ;" : "=r"(carry));\
        asm("mad.hi.cc.u32 %0, %1, %2, %0;" : "+r"(c2[4]) : "r"(b_loc[3]), "r"(a_loc[4]));\
        asm("addc.u32      %0, %0,  0    ;" : "+r"(carry));\
        asm("mad.hi.cc.u32 %0, %1, %2, %0;" : "+r"(c2[4]) : "r"(b_loc[4]), "r"(a_loc[3]));\
        asm("addc.u32      %0, %0,  0    ;" : "+r"(carry));\
        asm("mad.lo.cc.u32 %0, %1, %2, %0;" : "+r"(c2[4]) : "r"(b_loc[4]), "r"(a_loc[4]));\
        }\
        asm("add.cc.u32  %0, %1, %2;" : "=r"(a0_plus_a1[0]) : "r"(a_loc[0]), "r"(a_loc[2]));\
        asm("addc.cc.u32 %0, %1, %2;" : "=r"(a0_plus_a1[1]) : "r"(a_loc[1]), "r"(a_loc[3]));\
        asm("addc.u32    %0, %1,  0;" : "=r"(a0_plus_a1[2]) : "r"(a_loc[4]));\
        asm("add.cc.u32  %0, %1, %2;" : "=r"(b0_plus_b1[0]) : "r"(b_loc[0]), "r"(b_loc[2]));\
        asm("addc.cc.u32 %0, %1, %2;" : "=r"(b0_plus_b1[1]) : "r"(b_loc[1]), "r"(b_loc[3]));\
        asm("addc.u32    %0, %1,  0;" : "=r"(b0_plus_b1[2]) : "r"(b_loc[4]));\
        {\
        uint32_t carry = 0;\
