...
{\
    ...
    {\
        ...
        asm("subc.u32    %0, %1,  0;" : "=r"(c1[2]) : "r"(c1[2]));\
    }\
    {\
    ...
    {\
        asm("add.cc.u32  %0, %1, %2;" : "=r"(c_loc[1]) : "r"(c0[1]), "r"(c1[0]));\
    }\
    {\
        asm("addc.cc.u32 %0, %1, %2;" : "=r"(c_loc[2]) : "r"(c1[1]), "r"(c2[0]));\
        asm("addc.u32    %0, %1, %2;" : "=r"(c_loc[3]) : "r"(c1[2]), "r"(c2[1]));\
    }\
}
