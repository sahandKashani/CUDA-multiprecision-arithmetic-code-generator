...
{\
    ...
    uint32_t upper = 0;\
    asm("and.b32 %0, %0, 0xfffffff8;" : "+r"(A[4]) : );\
    asm("shr.b32 %0, %0, 3;" : "+r"(A[4]) : );\
    asm("and.b32 %0, %1, 0x00000007;" : "=r"(upper) : "r"(A[5]));\
    ...
    asm("add.u32 %0, %1,  0;" : "=r"(c_loc[0]) : "r"(A[4]));\
    asm("add.u32 %0, %1,  0;" : "=r"(c_loc[1]) : "r"(A[5]));\
    asm("add.u32 %0, %1,  0;" : "=r"(c_loc[2]) : "r"(A[6]));\
    asm("add.u32 %0, %1,  0;" : "=r"(c_loc[3]) : "r"(A[7]));\
    asm("add.u32 %0, %1,  0;" : "=r"(c_loc[4]) : "r"(A[8]));\
}
