...
asm("addc.u32      %0, %0,  0    ;" : "+r"(carry));\
asm("mad.hi.u32    %0, %1, %2, %3;" : "=r"(c_loc[11]) : "r"(b_loc[5]), "r"(a_loc[5]), "r"(carry));\
}\
}
...
uint32_t b0_plus_b1[4] = {0, 0, 0, 0};\
    ...
    uint32_t b0_plus_b1[3] = {0, 0, 0};\
            asm("mul.lo.u32    %0, %1, %2    ;" : "=r"(c2[0]) : "r"(b_loc[5]), "r"(a_loc[5]));\
            asm("mul.hi.u32    %0, %1, %2    ;" : "=r"(c2[1]) : "r"(b_loc[6]), "r"(a_loc[6]));\
    }\
}\
...
asm("addc.u32      %0, %0,  0    ;" : "+r"(carry));\
asm("mad.hi.u32    %0, %1, %2, %3;" : "=r"(c_glo[COAL_IDX(11, tid)]) : "r"(b_glo[COAL_IDX(5, tid)]), "r"(a_glo[COAL_IDX(5, tid)]), "r"(carry));\
}\
}
