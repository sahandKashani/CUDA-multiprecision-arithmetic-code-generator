 ...
 * length BITS_PER_WORD. The returned array will have BIGNUM_NUMBER_OF_WORDS
 * elements, with the least significant bits of the bignum at index 0, and the
 * most significant bits at index (BIGNUM_NUMBER_OF_WORDS - 1).
 ...
 * BIGNUM_NUMBER_OF_WORDS binary strings, each of which is BITS_PER_WORD
 * characters long.
