...
and here are the results for different grid and block sizes:

\begin{figure}[h]
\centering
\includegraphics[scale=0.4]{figs/assembly_vs_c_kepler_131}
\caption{C vs. assembly 131-bit addition kernel execution time}
\label{fig:assembly_vs_c_kepler_131}
\end{figure}
