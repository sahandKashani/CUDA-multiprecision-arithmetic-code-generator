...
% \begin{figure}[h]
% \centering
% \includegraphics[scale=0.5]{figs/multiplication}
...
% \begin{figure}[h]
% \centering
% \includegraphics[width=\linewidth]{figs/karatsuba_multiplication}
% \caption{Karatsuba multiplication algorithm}
% \label{fig:karatsuba_multiplication}
% \end{figure}
