...
GMP stores integers as arrays of machine words, under the type name of
\verb+mpz_t+.
...
\subsection{Our GPU memory representation}
...
therefore not explicitly needing runtime-level multiple precision arithmetic.
