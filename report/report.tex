...
\title{Implementing multiple-precision arithmetic on NVIDIA CUDA-enabled GPUs}
...
On CPUs, efficient multiple-precision arithmetic libraries provide solutions
these fields can use.

On CUDA GPUs, the smallest allocatable memory size for integers is 32 bits, or 4
bytes.
Even if one would want to use a \
